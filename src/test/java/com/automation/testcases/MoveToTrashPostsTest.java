...
public class MoveToTrashPostsTest extends ConfigurationBase {
	LoginBackendPage loginBackend;
	AdminPage adminPage;
	PostsPage postsPage;
	
	public MoveToTrashPostsTest() {
		super();
	}
	...
	@Test(priority=1)
	public void moveToTrashPostsTest() throws InterruptedException {
		postsPage.selectAllPostsTitle();
		postsPage.bulkActionMoveToTrash();
		Thread.sleep(2000);
